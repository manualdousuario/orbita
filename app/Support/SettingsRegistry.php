...
class SettingsRegistry
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'orbita.moderation.link_guard_enabled' => ['type' => self::TYPE_BOOL, 'group' => 'moderacao', 'label' => 'Revisar links suspeitos', 'help' => 'Ocultado o post ou comentário até um moderador revisar quando o link cai nas regras abaixo. O texto é salvo normalmente e a pessoa não recebe erro; a ocorrência fica registrada em Moderação.'],
            'orbita.moderation.link_domain_blocklist' => ['type' => self::TYPE_TEXT, 'group' => 'moderacao', 'label' => 'Domínios bloqueados', 'help' => 'Um domínio por linha. O domínio e os subdomínios dele contam, então "spam.com" também pega "go.spam.com". Vale para o link do post, o corpo do texto e o perfil. Linhas que começam com # são ignoradas.'],
            'orbita.moderation.link_domain_allowlist' => ['type' => self::TYPE_TEXT, 'group' => 'moderacao', 'label' => 'Domínios liberados', 'help' => 'Um domínio por linha, mesmo formato dos bloqueados. Links para estes domínios nunca mandam o conteúdo para revisão, mesmo vindos de uma conta nova. O domínio do próprio site já entra aqui sozinho.'],
            'orbita.moderation.link_trust_account_age_hours' => ['type' => self::TYPE_INT, 'group' => 'moderacao', 'label' => 'Idade da conta para publicar link (horas)', 'help' => 'Antes disso, um link externo no corpo do texto vai para revisão. Use 0 para não olhar a idade da conta.'],
            'orbita.moderation.link_trust_min_comments' => ['type' => self::TYPE_INT, 'group' => 'moderacao', 'label' => 'Comentários publicados para publicar link', 'help' => 'Quantos comentários visíveis a pessoa precisa ter antes de um link externo no corpo do texto deixar de ir para revisão. Use 0 para não olhar o histórico. Moderadores e administradores nunca são marcados.'],
